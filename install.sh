...
sudo apt update
sudo apt install curl alacritty pinta ranger fonts-fantasque-sans ripgrep code pcmanfm git valgrind vlc gnome-tweaks albert wmctrl
cargo install exa ripgrep exa fd-find bat bottom
